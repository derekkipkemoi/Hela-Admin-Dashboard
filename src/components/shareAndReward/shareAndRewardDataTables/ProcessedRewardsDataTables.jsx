...
function createData(referrerName, referrerPhone, points, amount, dateCreated) {
  return {
    referrerName,
    referrerPhone,
    points,
...
class ProcessedRewardsDataTables extends Component {
  state = {
    selectedPage: 1,
    pageSize: 5,
    data: dataData,
...
export default ProcessedRewardsDataTables;
