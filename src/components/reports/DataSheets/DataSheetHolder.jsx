...
class DataSheetHolder extends Component {
  state = {};
    ...
    return (
      <div className="advance-requests-holder">
        ...
        <div className="d-flex justify-content-between">
          <div className="header-reports-holder">Datasheets</div>
        ...
        <div className="row">
          <div className="col-sm-12 col-md-4 col-xl-3 col-xxl-3 mb-3">
            <div
              ...
              onClick={(e) => this.handleClick("/datasheets/datasheetsdata")}
              role="button"
            >
...
export default withRouter(DataSheetHolder);
