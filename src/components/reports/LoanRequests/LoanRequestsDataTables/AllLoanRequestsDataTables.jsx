...
function createData(names, phone, loanType, amount, createdAt) {
  return {
    names,
    phone,
    loanType,
...
class AllLoanRequestsDataTables extends Component {
  state = {
    selectedPage: 1,
    pageSize: 5,
    data: dataData,
...
export default AllLoanRequestsDataTables;
