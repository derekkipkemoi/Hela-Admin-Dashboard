...
class LoanRequestsHolder extends Component {
  state = {};
    ...
    return (
      <div className="advance-requests-holder">
        ...
        <div className="d-flex justify-content-between">
          <div className="header-reports-holder">Loan Requests</div>
        ...
        <div className="row">
          <div className="col-sm-12 col-md-4 col-xl-3 col-xxl-3 mb-3">
            <div
              ...
              onClick={(e) => this.handleClick("/loanrequests/allloanrequests")}
              role="button"
            >
...
export default withRouter(LoanRequestsHolder);
