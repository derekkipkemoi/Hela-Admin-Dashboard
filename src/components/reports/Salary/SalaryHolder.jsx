...
import { ArrowUpward, Link, Search } from "@mui/icons-material";
class SalaryHolder extends Component {
  state = {};
    ...
    return (
      <div className="advance-requests-holder">
        ...
        <div className="d-flex justify-content-between">
          <div className="header-reports-holder">Salary</div>
        ...
        <div className="row">
          <div className="col-sm-12 col-md-4 col-xl-3 col-xxl-3 mb-3">
            <div
              ...
              onClick={(e) => this.handleClick("/salary/salaryupdate")}
              role="button"
            >
          ...
          <div className="col-sm-12 col-md-4 col-xl-3 col-xxl-3 mb-3">
            <div
              className="card border text-dark p-4"
              style={cardBackgroundColor}
              onClick={(e) => this.handleClick("/salary/salaryadvances")}
              role="button"
            >
              <div className="card-content">
                <div
          ...
          <div className="col-sm-12 col-md-4 col-xl-3 col-xxl-3 mb-3">
            <div
              className="card border text-dark p-4"
              style={cardBackgroundColor}
              onClick={(e) => this.handleClick("/salary/salaryadvancesearch")}
              role="button"
            >
              <div className="card-content">
                <div
...
export default withRouter(SalaryHolder);
