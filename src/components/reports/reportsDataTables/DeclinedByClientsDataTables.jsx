import {
  ...
  dataData = dataData.filter((item) => item.status === "Declined By Clients")
  
  class DeclinedByClientsDataTables extends Component {
    state = {
      selectedPage: 1,
      pageSize: 10,
      data: dataData,
  ...
  export default DeclinedByClientsDataTables;
