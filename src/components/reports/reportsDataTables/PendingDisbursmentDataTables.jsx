import {
  ...
  dataData = dataData.filter((item) => item.status === "Pending Disbursement")
  
  class PendingDisbursmentDataTables extends Component {
    state = {
      selectedPage: 1,
      pageSize: 10,
      data: dataData,
  ...
  export default PendingDisbursmentDataTables;
