import {
  ...
  dataData = dataData.filter((item) => item.status === "Disbursement Error")
  
  class DisbursmentErrorDataTables extends Component {
    state = {
      selectedPage: 1,
      pageSize: 10,
      data: dataData,
  ...
  export default DisbursmentErrorDataTables;
