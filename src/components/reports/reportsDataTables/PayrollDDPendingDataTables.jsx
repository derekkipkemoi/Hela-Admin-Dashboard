import {
  ...
  dataData = dataData.filter((item) => item.status === "@Payroll - DD Pending")
  
  class PayrollDDPendingDataTables extends Component {
    state = {
      selectedPage: 1,
      pageSize: 10,
      data: dataData,
  ...
  export default PayrollDDPendingDataTables;
