import {
  ...
  dataData = dataData.filter((item) => item.status === "Pending Decline")
  
  class PendingDeclineRequestsDataTables extends Component {
    state = {
      selectedPage: 1,
      pageSize: 10,
      data: dataData,
  ...
  export default PendingDeclineRequestsDataTables;
