...
class MpesaDisbursedDataTables extends Component {
  state = {
    selectedPage: 1,
    pageSize: 5,
    data: dataData,
  ...
  filterData(inputValue) {
    ...
    const filtered = data.filter(
      (item) =>
        ...
        item.receiver.includes(inputValue) ||
        ...
        item.disbursed.toString().includes(inputValue) ||
          ...
          <div className="col d-flex justify-content-end col-md-3 col-xl-3">
            ...
            <div className="actions-top-icons-datatables">
              ...
              <ReactTooltip id="printMessage" type="info" effect="solid">
                <span>Print Mpesa Data List</span>
              </ReactTooltip>
            </div>
          </div>
        </div>
            ...
            {data.slice(0, this.state.pageSize).map((dataItem, index) => {
              return (
                <tr className="data-table-body-row" key={dataItem.nationalId}>
                  ...
                  <td>{dataItem.receiver}</td>
                  <td>{dataItem.mpesaName}</td>
...
export default MpesaDisbursedDataTables;
