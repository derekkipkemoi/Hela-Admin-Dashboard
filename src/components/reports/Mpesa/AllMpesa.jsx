...
import MpesaDisbursedDataTables from "./MpesaDataTables/MpesaDisbursedDataTables";
import MpesaReceivedPaymentDataTables from "./MpesaDataTables/MpesaReceivedPaymentDataTables";

const companiesOptions = appData.companies;

class AllMpesa extends Component {
  state = {
    requestStatus: null,
    selectedOptionValue: "",
    ...
    return (
      <div>
        ...
        <div className="all-advance-requests-holder">
          ...
          <div>
            {this.props.location.pathname === "/m_pesa/disbursement" ? (
              <MpesaDisbursedDataTables />
            ) : null}
            {this.props.location.pathname === "/m_pesa/paymentreceived" ? (
              <MpesaReceivedPaymentDataTables />
            ) : null}
          </div>
        </div>
      </div>
...
export default withRouter(AllMpesa);
