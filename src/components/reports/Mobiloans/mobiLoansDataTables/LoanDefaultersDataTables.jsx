import {
  ...
  for (let r = 0; r < 50; r++) {
    dataData[r] = createData(
      ...
      faker.finance.amount(),
      faker.finance.amount(),
      faker.date.between("2020-01-01T00:00:00.000Z", "2021-01-01T00:00:00.000Z"),
      faker.date.between("2022-01-01T00:00:00.000Z", "2022-01-01T00:00:00.000Z")
    );
  }
  
  class LoanDefaultersDataTables extends Component {
    state = {
      selectedPage: 1,
      pageSize: 5,
      data: dataData,
    ...
    filterData(inputValue) {
      ...
      const filtered = data.filter(
        (item) =>
          item.firstName.toString().includes(inputValue) ||
          item.middleName.includes(inputValue) ||
          item.surName.includes(inputValue) ||
          item.phone.toString().includes(inputValue) ||
          item.loanRef.toString().includes(inputValue) ||
          item.amount.includes(inputValue) ||
          item.reason.toString().includes(inputValue) ||
          item.createdAt.toString().includes(inputValue) ||
          item.updatedAt.toString().includes(inputValue) ||
  ...
  export default LoanDefaultersDataTables;
