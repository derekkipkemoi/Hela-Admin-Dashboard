import {
  ...
  function createData(firstName, surname, phone, amount, status, createdAt) {
    return {
      firstName,
      surname,
      phone,
  ...
  class RedeemCommissionRequestDataTables extends Component {
    state = {
      selectedPage: 1,
      pageSize: 5,
      data: dataData,
          ...
          <table id="bootstrapDataTable" className="data-table-class table">
            ...
            <tbody>
              {data.slice(0, this.state.pageSize).map((dataItem, index) => {
                return (
                  <tr className="data-table-body-row" key={dataItem.phone}>
  ...
  export default RedeemCommissionRequestDataTables;
