...
function createData(id, days, target, text, type, phoneNumber, status) {
  return {
    id,
    days,
    target,
...
class RemindersDataTable extends Component {
  state = {
    data: dataData,
    selectedPage: 1,
    pageSize: 10,
          ...
          <div className="pt-1 col d-flex justify-content-end col-md-3 col-xl-3">
            ...
            <div className="actions-top-icons-datatables">
              ...
              <ReactTooltip id="printMessage" type="info" effect="solid">
                <span>Print Reminders List</span>
              </ReactTooltip>
            </div>
          </div>
        </div>
...
export default RemindersDataTable;
