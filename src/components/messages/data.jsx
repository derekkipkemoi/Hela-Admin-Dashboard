export const messagesData = [
  ...
  {
    senderId: 3,
    sender: "The Shawshank Redemption",
    sentTime: "14/04/2021",
    runtime: "142",
    genres: ["Crime", "Drama"],
    ...
    message:
      "Two imprisoned men bond over a number of sentTimes, finding solace and eventual redemption through acts of common decency.",
    senderImage:
      "https://images-na.ssl-images-amazon.com/images/M/MV5BODU4MjU4NjIwNl5BMl5BanBnXkFtZTgwMDU2MjEyMDE@._V1_SX300.jpg"
  },
  {
    senderId: 4,
    sender: "Crocodile Dundee",
    sentTime: "1986",
    runtime: "97",
    genres: ["Adventure", "Comedy"],
    director: "Peter Faiman",
    actors: "Paul Hogan, Linda Kozlowski, John Meillon, DavsenderId Gulpilil",
    message:
  ...
  },
  {
    ...
    message:
      "A dramatization of the 20 July assassination and political coup message by desperate renegade German Army officers against Hitler during World War II.",
    senderImage:
  ...
  },
  {
    ...
    message:
      "After he becomes a quadriplegic from a paraglsenderIding accsenderIdent, an aristocrat hires a young man from the projects to be his caregiver.",
    senderImage:
  ...
  },
  {
    ...
    actors: "Ian McKellen, Bimbo Hart, Alastair MacIntosh, DavsenderId Kelly",
    message:
      "In a countryssenderIde town bordering on a magical land, a young man makes a promise to his beloved that he'll retrieve a fallen star by venturing into the magical realm.",
    senderImage:
  ...
  },
  {
    ...
    message:
      "As the Mayan kingdom faces its decline, the rulers insist the key to prosperity is to build more temples and offer human sacrifices. Jaguar Paw, a young man captured for sacrifice, flees to avosenderId his fate.",
    senderImage:
  ...
  },
  {
    ...
    message:
      "In 2074, when the mob wants to get rsenderId of someone, the target is sent into the past, where a hired gun awaits - someone like Joe - who one day learns the mob wants to 'close the loop' by sending back Joe's future self for assassination.",
    senderImage:
      "http://ia.media-imdb.com/images/M/MV5BMTY3NTY0MjEwNV5BMl5BanBnXkFtZTcwNTE3NDA1OA@@._V1_SX300.jpg"
  },
  {
    senderId: 16,
    sender: "Corpse BrsenderIde",
    sentTime: "2005",
    runtime: "77",
  ...
  {
    senderId: 17,
    sender: "The Third Man",
    sentTime: "1949",
    runtime: "93",
    genres: ["Film-Noir", "Mystery", "Thriller"],
    director: "Carol Reed",
    actors: "Joseph Cotten, AlsenderIda Valli, Orson Welles, Trevor Howard",
    message:
  ...
  {
    senderId: 20,
    sender: "SsenderId and Nancy",
    sentTime: "1986",
    runtime: "112",
    genres: ["Biography", "Drama", "Music"],
    director: "Alex Cox",
    actors: "Gary Oldman, Chloe Webb, DavsenderId Hayman, Debby Bishop",
    message:
      "MorbsenderId biographical story of SsenderId Vicious, bassist with British punk group the Sex Pistols, and his girlfriend Nancy Spungen. When the Sex Pistols break up after their fateful US tour, ...",
    senderImage:
  ...
  },
  {
    ...
    message:
      "A thief, who steals corporate secrets through use of dream-sharing technology, is given the inverse task of planting an senderIdea into the mind of a CEO.",
    senderImage:
      "https://images-na.ssl-images-amazon.com/images/M/MV5BMjAxMzY3NjcxNF5BMl5BanBnXkFtZTcwNTI5OTM0Mw@@._V1_SX300.jpg"
  },
  {
    senderId: 23,
    sender: "The Deer Hunter",
    sentTime: "1978",
    runtime: "183",
    genres: ["Drama", "War"],
  ...
  {
    senderId: 26,
    sender: "The Silence of the Lambs",
    sentTime: "1991",
    runtime: "118",
    genres: ["Crime", "Drama", "Thriller"],
    ...
    message:
      "A young F.B.I. cadet must confsenderIde in an incarcerated and manipulative killer to receive his help on catching another serial killer who skins his victims.",
    senderImage:
      "https://images-na.ssl-images-amazon.com/images/M/MV5BMTQ2NzkzMDI4OF5BMl5BanBnXkFtZTcwMDA0NzE1NA@@._V1_SX300.jpg"
  },
  {
    senderId: 27,
    sender: "American Beauty",
    sentTime: "1999",
    runtime: "122",
    ...
    message:
      "A sexually frustrated suburban father has a msenderId-life crisis after becoming infatuated with his daughter's best friend.",
    senderImage:
  ...
  {
    senderId: 31,
    sender: "Lock, Stock and Two Smoking Barrels",
    sentTime: "1998",
    runtime: "107",
    genres: ["Comedy", "Crime"],
    director: "Guy Ritchie",
    ...
    message:
      "A botched card game in London triggers four friends, thugs, weed-growers, hard gangsters, loan sharks and debt collectors to collsenderIde with each other in a series of unexpected events, all for the sake of weed, cash and two antique shotguns.",
    senderImage:
  ...
  },
  {
    ...
    message:
      "A case of mistaken senderIdentity lands Slevin into the msenderIddle of a war being messageted by two of the city's most rival crime bosses: The Rabbi and The Boss. Slevin is under constant surveillance by relentless Detective Brikowski as well as the infamous assassin Goodkat and finds himself having to hatch his own ingenious message to get them before they get him.",
    senderImage:
  ...
  {
    senderId: 38,
    sender: "MsenderIdnight in Paris",
    sentTime: "2011",
    runtime: "94",
    ...
    message:
      "While on a trip to Paris with his fiancée's family, a nostalgic screenwriter finds himself mysteriously going back to the 1920s everyday at msenderIdnight.",
    senderImage:
      "http://ia.media-imdb.com/images/M/MV5BMTM4NjY1MDQwMl5BMl5BanBnXkFtZTcwNTI3Njg3NA@@._V1_SX300.jpg"
  },
  {
    senderId: 39,
    sender: "Les Misérables",
    sentTime: "2012",
    runtime: "158",
  ...
  },
  {
    ...
    message:
      "A tale of friendship between two unlikely pen pals: Mary, a lonely, eight-sentTime-old girl living in the suburbs of Melbourne, and Max, a forty-four-sentTime old, severely obese man living in New York.",
    senderImage:
  ...
  },
  {
    ...
    message:
      "An airline pilot saves almost all his passengers on his malfunctioning airliner which eventually crashed, but an investigation into the accsenderIdent reveals something troubling.",
    senderImage:
      "https://images-na.ssl-images-amazon.com/images/M/MV5BMTUxMjI1OTMxNl5BMl5BanBnXkFtZTcwNjc3NTY1OA@@._V1_SX300.jpg"
  },
  {
    senderId: 47,
    sender: "One Flew Over the Cuckoo's Nest",
    sentTime: "1975",
    runtime: "133",
    genres: ["Drama"],
  ...
  },
  {
    ...
    message:
      "Forrest Gump, while not intelligent, has accsenderIdentally been present at many historic moments, but his true love, Jenny Curran, eludes him.",
    senderImage:
  ...
  {
    senderId: 52,
    sender: "The Hobbit: The Desolation of Smaug",
    sentTime: "2013",
    runtime: "161",
  ...
  {
    senderId: 53,
    sender: "Vicky Cristina Barcelona",
    sentTime: "2008",
    runtime: "96",
    genres: ["Drama", "Romance"],
    director: "Woody Allen",
    ...
    message:
      "Two girlfriends on a summer holsenderIday in Spain become enamored with the same painter, unaware that his ex-wife, with whom he has a tempestuous relationship, is about to re-enter the picture.",
    senderImage:
      "https://images-na.ssl-images-amazon.com/images/M/MV5BMTU2NDQ4MTg2MV5BMl5BanBnXkFtZTcwNDUzNjU3MQ@@._V1_SX300.jpg"
  },
  {
    senderId: 54,
    sender: "Slumdog Millionaire",
    sentTime: "2008",
    runtime: "120",
    genres: ["Drama", "Romance"],
  ...
  {
    senderId: 59,
    sender: "Madagascar: Escape 2 Africa",
    sentTime: "2008",
    runtime: "89",
    genres: ["Animation", "Action", "Adventure"],
    director: "Eric Darnell, Tom McGrath",
    actors: "Ben Stiller, Chris Rock, DavsenderId Schwimmer, Jada Pinkett Smith",
    message:
  ...
  },
  {
    ...
    actors: "Ben Stiller, Chris Rock, DavsenderId Schwimmer, Jada Pinkett Smith",
    message:
      "Spoiled by their upbringing with no senderIdea what wild life is really like, four animals from New York Central Zoo escape, unwittingly assisted by four absconding penguins, and find themselves in Madagascar, among a bunch of merry lemurs",
    senderImage:
      "https://images-na.ssl-images-amazon.com/images/M/MV5BMTY4NDUwMzQxMF5BMl5BanBnXkFtZTcwMDgwNjgyMQ@@._V1_SX300.jpg"
  },
  {
    senderId: 63,
    sender: "Madagascar 3: Europe's Most Wanted",
    sentTime: "2012",
    runtime: "93",
    genres: ["Animation", "Adventure", "Comedy"],
  ...
  },
  {
    ...
    message:
      "On a mission to rsenderId society of its most repellent citizens, terminally ill Frank makes an unlikely accomplice in 16-sentTime-old Roxy.",
    senderImage:
      "https://images-na.ssl-images-amazon.com/images/M/MV5BMTQwMTc1MzA4NF5BMl5BanBnXkFtZTcwNzQwMTgzNw@@._V1_SX300.jpg"
  },
  {
    senderId: 65,
    sender: "The Social Network",
    sentTime: "2010",
    runtime: "120",
    genres: ["Biography", "Drama"],
    director: "DavsenderId Fincher",
    actors: "Jesse Eisenberg, Rooney Mara, Bryan Barter, Dustin Fitzsimons",
    message:
      "Harvard student Mark Zuckerberg creates the social networking site that would become known as Facebook, but is later sued by two brothers who claimed he stole their senderIdea, and the co-founder who was later squeezed out of the business.",
    senderImage:
  ...
  },
  {
    ...
    actors: "Humphrey Bogart, IngrsenderId Bergman, Paul HenresenderId, Claude Rains",
    message:
  ...
  {
    senderId: 69,
    sender: "American Gangster",
    sentTime: "2007",
    runtime: "157",
    genres: ["Biography", "Crime", "Drama"],
    director: "RsenderIdley Scott",
  ...
  },
  {
    ...
    message:
      "A former neo-nazi skinhead tries to prevent his younger brother from going down the same wrong path that he dsenderId.",
    senderImage:
  ...
  {
    senderId: 73,
    sender: "Pirates of the Caribbean: At World's End",
    sentTime: "2007",
    runtime: "169",
  ...
  {
    senderId: 74,
    sender: "Pirates of the Caribbean: On Stranger TsenderIdes",
    sentTime: "2011",
    runtime: "136",
    genres: ["Action", "Adventure", "Fantasy"],
  ...
  },
  {
    ...
    message:
      "Los Angeles citizens with vastly separate lives collsenderIde in interweaving stories of race, loss and redemption.",
    senderImage:
      "https://images-na.ssl-images-amazon.com/images/M/MV5BOTk1OTA1MjIyNV5BMl5BanBnXkFtZTcwODQxMTkyMQ@@._V1_SX300.jpg"
  },
  {
    senderId: 76,
    sender: "Pirates of the Caribbean: The Curse of the Black Pearl",
    sentTime: "2003",
    runtime: "143",
    genres: ["Action", "Adventure", "Fantasy"],
    director: "Gore Verbinski",
  ...
  {
    senderId: 77,
    sender: "The Lord of the Rings: The Return of the King",
    sentTime: "2003",
    runtime: "201",
    genres: ["Action", "Adventure", "Drama"],
    director: "Peter Jackson",
    actors: "Noel Appleby, Ali Astin, Sean Astin, DavsenderId Aston",
    message:
  ...
  },
  {
    ...
    message:
      "After being ksenderIdnapped and imprisoned for 15 sentTimes, Oh Dae-Su is released, only to find that he must find his captor in 5 days.",
    senderImage:
  ...
  },
  {
    ...
    message:
      "A woman and her daughter open a chocolate shop in a small French village that shakes up the rigsenderId morality of the community.",
    senderImage:
      "https://images-na.ssl-images-amazon.com/images/M/MV5BMjA4MDI3NTQwMV5BMl5BanBnXkFtZTcwNjIzNDcyMQ@@._V1_SX300.jpg"
  },
  {
    senderId: 80,
    sender: "Casino Royale",
    sentTime: "2006",
    runtime: "144",
  ...
  },
  {
    ...
    message:
      "In the distant future, a small waste-collecting robot inadvertently embarks on a space journey that will ultimately decsenderIde the fate of mankind.",
    senderImage:
      "https://images-na.ssl-images-amazon.com/images/M/MV5BMTczOTA3MzY2N15BMl5BanBnXkFtZTcwOTYwNjE2MQ@@._V1_SX300.jpg"
  },
  {
    senderId: 82,
    sender: "The Wolf of Wall Street",
    sentTime: "2013",
    runtime: "180",
  ...
  {
    senderId: 83,
    sender: "Hellboy II: The Golden Army",
    sentTime: "2008",
    runtime: "120",
    genres: ["Action", "Adventure", "Fantasy"],
    director: "Guillermo del Toro",
  ...
  {
    senderId: 85,
    sender: "I-See-You.Com",
    sentTime: "2006",
    runtime: "92",
    genres: ["Comedy"],
    director: "Eric Steven Stahl",
    actors: "Beau BrsenderIdges, Rosanna Arquette, Mathew Botuchis, Shiri Appleby",
    message:
      "A 17-sentTime-old boy buys mini-cameras and displays the footage online at I-see-you.com. The cash rolls in as the site becomes a major hit. Everyone seems to have fun until it all comes crashing down....",
    senderImage:
      "https://images-na.ssl-images-amazon.com/images/M/MV5BMTYwMDUzNzA5Nl5BMl5BanBnXkFtZTcwMjQ2Njk3MQ@@._V1_SX300.jpg"
  },
  {
    senderId: 86,
    sender: "The Grand Budapest Hotel",
    sentTime: "2014",
    runtime: "99",
  ...
  {
    senderId: 87,
    sender: "The Hitchhiker's GusenderIde to the Galaxy",
    sentTime: "2005",
    runtime: "109",
    ...
    message:
      'Mere seconds before the Earth is to be demolished by an alien construction crew, journeyman Arthur Dent is swept off the planet by his friend Ford Prefect, a researcher penning a new edition of "The Hitchhiker\'s GusenderIde to the Galaxy."',
    senderImage:
      "http://ia.media-imdb.com/images/M/MV5BMjEwOTk4NjU2MF5BMl5BanBnXkFtZTYwMDA3NzI3._V1_SX300.jpg"
  },
  {
    senderId: 88,
    sender: "Once Upon a Time in America",
    sentTime: "1984",
    runtime: "229",
    genres: ["Crime", "Drama"],
    ...
    message:
      "A former Prohibition-era Jewish gangster returns to the Lower East SsenderIde of Manhattan over thirty sentTimes later, where he once again must confront the ghosts and regrets of his old life.",
    senderImage:
  ...
  },
  {
    ...
    message:
      'In a future British tyranny, a shadowy freedom fighter, known only by the alias of "V", messages to overthrow it with the help of a young woman.',
    senderImage:
  ...
  },
  {
    ...
    actors: "Ethan Hawke, Uma Thurman, Gore VsenderIdal, Xander Berkeley",
    message:
      "A genetically inferior man assumes the senderIdentity of a superior one in order to pursue his lifelong dream of space travel.",
    senderImage:
  ...
  {
    senderId: 92,
    sender: "Silver Linings Playbook",
    sentTime: "2012",
    runtime: "122",
    genres: ["Comedy", "Drama", "Romance"],
    director: "DavsenderId O. Russell",
  ...
  },
  {
    ...
    message:
      "Nineteen-sentTime-old Alice returns to the magical world from her childhood adventure, where she reunites with her old friends and learns of her true destiny: to end the Red Queen's reign of terror.",
    senderImage:
  ...
  },
  {
    ...
    genres: ["Action", "Adventure", "Sci-Fi"],
    director: "Guillermo del Toro",
    actors: "Charlie Hunnam, Diego Klattenhoff, senderIdris Elba, Rinko Kikuchi",
    message:
  ...
  },
  {
    ...
    message:
      "An exploration of how the actions of indivsenderIdual lives impact one another in the past, present and future, as one soul is shaped from a killer into a hero, and an act of kindness ripples across centuries to inspire a revolution.",
    senderImage:
      "https://images-na.ssl-images-amazon.com/images/M/MV5BMTczMTgxMjc4NF5BMl5BanBnXkFtZTcwNjM5MTA2OA@@._V1_SX300.jpg"
  },
  {
    senderId: 99,
    sender: "The Impossible",
    sentTime: "2012",
    runtime: "114",
    genres: ["Drama", "Thriller"],
    director: "J.A. Bayona",
  ...
  {
    senderId: 100,
    sender: "All Quiet on the Western Front",
    sentTime: "1930",
    runtime: "136",
    genres: ["Drama", "War"],
